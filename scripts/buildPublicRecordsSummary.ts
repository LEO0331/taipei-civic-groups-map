...
import type { CivicGroupSummary, IndustryGrantSummary, LaborStandardActViolationSummary, MetroProcurementScheduleSummary, NangangSoftwareParkCompanySummary, RegisteredCramSchoolSummary, RegisteredHotelSummary } from '../src/types';

const dataDir = join(process.cwd(), 'public/data');
const [civicGroups, industryGrants, metroProcurement, registeredCramSchools, registeredHotels, laborViolations, nangangCompanies] = await Promise.all([
