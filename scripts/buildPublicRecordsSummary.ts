...
import type { CivicGroupSummary, IndustryGrantSummary, MetroProcurementScheduleSummary } from '../src/types';

const dataDir = join(process.cwd(), 'public/data');
const [civicGroups, industryGrants, metroProcurement] = await Promise.all([
