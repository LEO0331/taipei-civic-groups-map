...
import type {
  ...
  RegisteredHotel, RegisteredHotelSummary, DawannanIndustrialAreaCompanyRecord, DawannanIndustrialAreaCompanySummary, LaborStandardActViolationManifest, LaborStandardActViolationSummary, NangangSoftwareParkCompany, NangangSoftwareParkCompanySummary, OccupationalSafetyHealthViolationRecord, OccupationalSafetyHealthViolationSummary,
...
const copy = {
  zh: {
    ...
    footer: '資料來源：臺北市人民團體名冊、臺北市演藝團體名冊、臺北市各工會名單及聯絡方式、臺北市身障就業資源地圖、臺北市庇護工場名冊、臺北市政府警察局當舖業資料清冊、各項預防接種合約醫療院所、臺北市公費HPV疫苗特約醫療院所、臺北市兒童醫療補助特約院所名冊、臺北市假牙補助醫療院所名單、臺北市可執行通訊心理諮商之心理機構、臺北市營業場所投保公共意外險清冊、商業設立變更歇業登記異動資料、臺北市核准公司設立變更解散清冊、產業補助、臺北市生技廠商企業名錄、捷運採購、立案補習班、一般旅館、臺北旅遊網住宿資料、勞基法違規公布、臺北市消費爭議無故不到場協商之被申訴企業經營者列表、南港軟體工業園區廠商、臺北市大彎南段工業區廠商名錄、臺北市動物醫院一覽表、臺北市準公共化托嬰中心、臺北市托嬰中心評鑑結果與臺北市老人福利機構名冊等公開資料。各資料集性質不同，最新與正式資訊請以主管機關正式公告及官方系統為準。',
  },
  en: {
...
export default function App() {
  ...
  const tabs = [
    ...
    ['cramSchools', t.registeredCramSchools], ['hotels', t.registeredHotels], ['laborViolations', t.laborViolations], ['oshViolations', t.oshViolations], ['consumerDisputeAbsence', t.consumerDisputeAbsence], ['nangangCompanies', t.nangangCompanies], ['dawannanCompanies', t.dawannanCompanies],
