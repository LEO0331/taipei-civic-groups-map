...
function CombinedOverview({ civic, performingArts, vaccinationProviders, hpvProviders, childMedicalSubsidyProviders, dentureSubsidyProviders, disabilityEmploymentResources, shelteredWorkshops, licensedPawnshops, licensedArcades, licensedSpecialEntertainment, telepsychology, publicLiabilityInsurance, businessChanges, companyChanges, laborUnions, infantCare, infantCareEvaluations, elderlyWelfare, biotechCompanies, travelAccommodations, grants, procurement, cramSchools, hotels, laborViolations, oshViolations, genderEqualityViolations, consumerDisputeAbsence, nangangCompanies, dawannanCompanies, animalHospitals, veterinarians, language }: {
