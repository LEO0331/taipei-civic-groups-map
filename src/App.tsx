...
import type {
  ...
  BiotechCompanyDirectoryRecord, BiotechCompanyDirectorySummary, BusinessPremisesPublicLiabilityInsuranceRecord, BusinessPremisesPublicLiabilityInsuranceSummary, BusinessRegistrationChangeRecord, BusinessRegistrationChangeSummary, CompanyRegistrationChangeRecord, CompanyRegistrationChangeSummary, ConsumerDisputeAbsentBusinessOperatorRecord, ConsumerDisputeAbsentBusinessOperatorSummary, ContractedVaccinationMedicalProviderRecord, ContractedVaccinationMedicalProviderSummary, ElderlyWelfareInstitutionRecord, ElderlyWelfareInstitutionSummary, PubliclyFundedHpvVaccinationProviderRecord, PubliclyFundedHpvVaccinationProviderSummary, TelepsychologyCounselingInstitutionRecord, TelepsychologyCounselingInstitutionSummary,
} from './types';

const copy = {
  zh: {
    title: '台北公共登記與行政紀錄地圖', subtitle: '人民團體、演藝團體、工會、醫療與心理健康院所、HPV疫苗院所、公共意外險、商業異動、公司異動、立案機構、旅宿、旅遊住宿、採購、補助、生技廠商、法規、消費爭議公告、產業園區、動物照護、兒童照護與老人福利機構公開紀錄探索',
    civicGroups: '人民團體', performingArtsGroups: '演藝團體', vaccinationProviders: '預防接種院所', hpvProviders: 'HPV疫苗院所', telepsychology: '通訊心理諮商', publicLiabilityInsurance: '公共意外險', businessChanges: '商業異動', companyChanges: '公司異動', laborUnions: '工會名單', infantCareCenters: '準公共化托嬰中心', elderlyWelfare: '老人福利機構', biotechCompanies: '生技廠商', travelAccommodations: '旅遊住宿', industryGrants: '產業補助廠商', metroProcurement: '捷運採購時程', registeredCramSchools: '立案補習班', registeredHotels: '一般旅館名冊', laborViolations: '勞基法違規公布紀錄', consumerDisputeAbsence: '消費爭議不到場公告', nangangCompanies: '南港軟體工業園區廠商', animalHospitals: '動物醫院一覽表', comparison: '行政區比較',
    ...
    footer: '資料來源：臺北市人民團體名冊、臺北市演藝團體名冊、臺北市各工會名單及聯絡方式、各項預防接種合約醫療院所、臺北市公費HPV疫苗特約醫療院所、臺北市可執行通訊心理諮商之心理機構、臺北市營業場所投保公共意外險清冊、商業設立變更歇業登記異動資料、臺北市核准公司設立變更解散清冊、產業補助、臺北市生技廠商企業名錄、捷運採購、立案補習班、一般旅館、臺北旅遊網住宿資料、勞基法違規公布、臺北市消費爭議無故不到場協商之被申訴企業經營者列表、南港軟體工業園區廠商、臺北市動物醫院一覽表、臺北市準公共化托嬰中心與臺北市老人福利機構名冊等公開資料。各資料集性質不同，最新與正式資訊請以主管機關正式公告及官方系統為準。',
  },
  en: {
    title: 'Taipei Public Records Explorer', subtitle: 'Civic groups, performing-arts groups, labor unions, healthcare and mental-health providers, HPV vaccine providers, public liability insurance, business changes, company changes, registered institutions, lodging records, travel accommodations, procurement, grants, biotech companies, compliance, consumer dispute notices, industry park, animal-care, childcare, and elderly-care public records explorer',
    civicGroups: 'Civic Groups', performingArtsGroups: 'Performing Arts', vaccinationProviders: 'Vaccination Providers', hpvProviders: 'HPV Vaccine Providers', telepsychology: 'Telepsychology', publicLiabilityInsurance: 'Public Liability Insurance', businessChanges: 'Business Changes', companyChanges: 'Company Changes', laborUnions: 'Labor Unions', infantCareCenters: 'Quasi-Public Infant Care Centers', elderlyWelfare: 'Elderly Care', biotechCompanies: 'Biotech Companies', travelAccommodations: 'Travel Accommodations', industryGrants: 'Industry Grant Recipients', metroProcurement: 'Metro Procurement Schedule', registeredCramSchools: 'Registered Cram Schools', registeredHotels: 'Registered Hotels', laborViolations: 'Labor Standards Act Violation Records', consumerDisputeAbsence: 'Consumer Dispute Absence Notices', nangangCompanies: 'Nangang Software Park Companies', animalHospitals: 'Registered Animal Hospitals', comparison: 'District Comparison',
    ...
    footer: 'Data sources: Taipei civic groups, Taipei performing-arts group registry dataset, registered labor unions, Taipei contracted vaccination medical provider records, Taipei publicly funded HPV vaccination provider records, Taipei telepsychology counseling institution records, Taipei business premises public liability insurance records, Taipei business registration change records, Taipei company registration change records, industry grants, Taipei biotech company directory records, Metro procurement, registered cram schools, registered hotels, Taipei Travel accommodation dataset, Labor Standards Act violation publication records, Taipei consumer dispute absent business operator notices, Nangang Software Park company directory, Taipei animal hospital directory, Taipei quasi-public infant care center records, Taipei elderly welfare institution directory records, and related public data. These datasets have different meanings. Latest official information should be verified with authorities and official systems.',
  },
} as const;
...
function CombinedOverview({ civic, performingArts, vaccinationProviders, hpvProviders, telepsychology, publicLiabilityInsurance, businessChanges, companyChanges, laborUnions, infantCare, elderlyWelfare, biotechCompanies, travelAccommodations, grants, procurement, cramSchools, hotels, laborViolations, consumerDisputeAbsence, nangangCompanies, animalHospitals, language }: {
  civic: CivicGroupSummary; performingArts: PerformingArtsGroupSummary; vaccinationProviders: ContractedVaccinationMedicalProviderSummary; hpvProviders: PubliclyFundedHpvVaccinationProviderSummary; telepsychology: TelepsychologyCounselingInstitutionSummary; publicLiabilityInsurance: BusinessPremisesPublicLiabilityInsuranceSummary; businessChanges: BusinessRegistrationChangeSummary; companyChanges: CompanyRegistrationChangeSummary; laborUnions: RegisteredLaborUnionSummary; infantCare: QuasiPublicInfantCareCenterSummary; elderlyWelfare: ElderlyWelfareInstitutionSummary; biotechCompanies: BiotechCompanyDirectorySummary; travelAccommodations: TaipeiTravelAccommodationZhSummary; grants: IndustryGrantSummary; procurement: MetroProcurementScheduleSummary; cramSchools: RegisteredCramSchoolSummary; hotels: RegisteredHotelSummary; laborViolations: LaborStandardActViolationSummary; consumerDisputeAbsence: ConsumerDisputeAbsentBusinessOperatorSummary; nangangCompanies: NangangSoftwareParkCompanySummary; animalHospitals: RegisteredAnimalHospitalSummary; language: Language;
}) {
...
export default function App() {
  ...
  const [tab, setTab] = useState<'civic' | 'performingArts' | 'vaccinationProviders' | 'hpvProviders' | 'telepsychology' | 'publicLiabilityInsurance' | 'businessChanges' | 'companyChanges' | 'laborUnions' | 'infantCare' | 'elderlyWelfare' | 'biotechCompanies' | 'travelAccommodations' | 'grants' | 'procurement' | 'cramSchools' | 'hotels' | 'laborViolations' | 'consumerDisputeAbsence' | 'nangangCompanies' | 'animalHospitals' | 'comparison' | 'overview' | 'notes'>('civic');
  ...
  const [report, setReport] = useState<{
    convertedAt?: string; performingArtsGroups?: { convertedAt?: string }; contractedVaccinationMedicalProviders?: { convertedAt?: string }; publiclyFundedHpvVaccinationProviders?: { convertedAt?: string }; telepsychologyCounselingInstitutions?: { convertedAt?: string }; businessPremisesPublicLiabilityInsuranceRecords?: { convertedAt?: string }; businessRegistrationChangeRecords?: { convertedAt?: string }; companyRegistrationChangeRecords?: { convertedAt?: string }; registeredLaborUnions?: { convertedAt?: string }; quasiPublicInfantCareCenters?: { convertedAt?: string }; elderlyWelfareInstitutions?: { convertedAt?: string }; biotechCompanyDirectory?: { convertedAt?: string }; taipeiTravelAccommodationsZh?: { convertedAt?: string }; industryGrantRecipients?: { convertedAt?: string }; metroProcurementSchedules?: { convertedAt?: string }; registeredCramSchools?: { convertedAt?: string }; registeredHotels?: { convertedAt?: string }; laborStandardActViolationRecords?: { convertedAt?: string }; consumerDisputeAbsentBusinessOperators?: { convertedAt?: string }; nangangSoftwareParkCompanies?: { convertedAt?: string }; registeredAnimalHospitals?: { convertedAt?: string };
  }>({});
  ...
  useEffect(() => {
    ...
    ]).then(([groupData, summaryData, performingArtsData, performingArtsSummaryData, vaccinationProviderData, vaccinationProviderSummaryData, hpvProviderData, hpvProviderSummaryData, telepsychologyData, telepsychologySummaryData, publicLiabilityData, publicLiabilitySummaryData, businessChangeData, businessChangeSummaryData, companyChangeData, companyChangeSummaryData, laborUnionData, laborUnionSummaryData, infantCareData, infantCareSummaryData, elderlyWelfareData, elderlyWelfareSummaryData, biotechData, biotechSummaryData, travelData, travelSummaryData, grantData, grantSummaryData, procurementData, procurementSummaryData, cramSchoolData, cramSchoolSummaryData, hotelData, hotelSummaryData, laborSummaryData, laborManifestData, consumerDisputeData, consumerDisputeSummaryData, nangangData, nangangSummaryData, animalData, animalSummaryData, reportData]) => {
  ...
  const tabs = [
    ['civic', t.civicGroups], ['performingArts', t.performingArtsGroups], ['vaccinationProviders', t.vaccinationProviders], ['hpvProviders', t.hpvProviders], ['telepsychology', t.telepsychology], ['publicLiabilityInsurance', t.publicLiabilityInsurance], ['businessChanges', t.businessChanges], ['companyChanges', t.companyChanges], ['laborUnions', t.laborUnions], ['infantCare', t.infantCareCenters], ['elderlyWelfare', t.elderlyWelfare], ['biotechCompanies', t.biotechCompanies], ['travelAccommodations', t.travelAccommodations], ['grants', t.industryGrants], ['procurement', t.metroProcurement],
  ...
  return <div className="app">
    ...
    <main>
      ...
      {!loadError && (!summary || !performingArtsSummary || !vaccinationProviderSummary || !hpvProviderSummary || !telepsychologySummary || !publicLiabilitySummary || !businessChangeSummary || !companyChangeSummary || !laborUnionSummary || !infantCareSummary || !elderlyWelfareSummary || !biotechCompanySummary || !travelAccommodationSummary || !grantSummary || !procurementSummary || !cramSchoolSummary || !hotelSummary || !laborViolationSummary || !laborViolationManifest || !consumerDisputeSummary || !nangangCompanySummary || !animalHospitalSummary) && <p className="status" role="status">{t.loading}</p>}
      ...
      {tab === 'overview' && summary && performingArtsSummary && vaccinationProviderSummary && hpvProviderSummary && telepsychologySummary && publicLiabilitySummary && businessChangeSummary && companyChangeSummary && laborUnionSummary && infantCareSummary && elderlyWelfareSummary && biotechCompanySummary && travelAccommodationSummary && grantSummary && procurementSummary && cramSchoolSummary && hotelSummary && laborViolationSummary && consumerDisputeSummary && nangangCompanySummary && animalHospitalSummary && <CombinedOverview civic={summary} performingArts={performingArtsSummary} vaccinationProviders={vaccinationProviderSummary} hpvProviders={hpvProviderSummary} telepsychology={telepsychologySummary} publicLiabilityInsurance={publicLiabilitySummary} businessChanges={businessChangeSummary} companyChanges={companyChangeSummary} laborUnions={laborUnionSummary} infantCare={infantCareSummary} elderlyWelfare={elderlyWelfareSummary} biotechCompanies={biotechCompanySummary} travelAccommodations={travelAccommodationSummary} grants={grantSummary} procurement={procurementSummary} cramSchools={cramSchoolSummary} hotels={hotelSummary} laborViolations={laborViolationSummary} consumerDisputeAbsence={consumerDisputeSummary} nangangCompanies={nangangCompanySummary} animalHospitals={animalHospitalSummary} language={language} />}
      {tab === 'notes' && <section className="workspace notes"><div className="section-heading"><p>09 / METHODOLOGY</p><h2>{t.notes}</h2></div>
        <blockquote>{language === 'zh' ? '本網站整理臺北市公開資料中的人民團體名冊、演藝團體名冊、工會名單、產業補助廠商資料、生技廠商企業名錄、捷運採購案件預定招標時程、立案補習班資訊、一般旅館名冊、臺北旅遊網住宿資料、勞基法違規公布紀錄、消費爭議不到場公告、南港軟體工業園區廠商資料、動物醫院一覽表、準公共化托嬰中心、老人福利機構名冊、各項預防接種合約醫療院所、公費HPV疫苗特約醫療院所、可執行通訊心理諮商之心理機構、營業場所投保公共意外險清冊、商業設立變更及歇業登記異動資料、公司設立變更及解散登記異動資料等公開資料，僅供資料探索與整理使用。各資料集性質不同，不應直接解讀為相同類型組織、活動、服務可用性、即時營業狀態、醫療建議、疫苗接種建議、法規遵循狀態、法律責任、信用狀態、投資訊號、黑名單、法律意見、財務建議或官方背書。最新與正式資訊請以主管機關正式公告及官方系統為準。' : 'This site organizes Taipei public-data records such as civic group directory records, performing-arts group registry records, labor union directory records, industry grant recipient records, biotech company directory records, Taipei Metro planned procurement tender schedules, registered cram-school records, registered hotel records, Taipei Travel accommodation records, Labor Standards Act violation publication records, consumer dispute absence notices, Nangang Software Park company records, animal hospital directory records, quasi-public infant care center records, elderly welfare institution directory records, contracted vaccination medical provider records, publicly funded HPV vaccination provider records, telepsychology counseling institution records, business premises public liability insurance records, business establishment / modification / closure registration change records, company establishment / modification / dissolution registration change records, and related public records for data exploration and organization only. These datasets have different meanings and should not be interpreted as the same type of organization, activity, service availability, real-time operating status, medical advice, vaccination advice, legal compliance status, legal liability, credit status, investment signal, blacklist, legal advice, financial advice, or official endorsement. Latest and official information should be verified with official authority notices and official systems.'}</blockquote>
