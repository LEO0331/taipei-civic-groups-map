...
function CombinedOverview({ civic, performingArts, vaccinationProviders, hpvProviders, childMedicalSubsidyProviders, dentureSubsidyProviders, disabilityEmploymentResources, shelteredWorkshops, licensedPawnshops, telepsychology, publicLiabilityInsurance, businessChanges, companyChanges, laborUnions, infantCare, infantCareEvaluations, elderlyWelfare, biotechCompanies, travelAccommodations, grants, procurement, cramSchools, hotels, laborViolations, consumerDisputeAbsence, nangangCompanies, animalHospitals, language }: {
...
export default function App() {
  ...
  const [tab, setTab] = useState<'civic' | 'performingArts' | 'vaccinationProviders' | 'hpvProviders' | 'childMedicalSubsidyProviders' | 'dentureSubsidyProviders' | 'disabilityEmploymentResources' | 'shelteredWorkshops' | 'licensedPawnshops' | 'telepsychology' | 'publicLiabilityInsurance' | 'businessChanges' | 'companyChanges' | 'laborUnions' | 'infantCare' | 'infantCareEvaluations' | 'elderlyWelfare' | 'biotechCompanies' | 'travelAccommodations' | 'grants' | 'procurement' | 'cramSchools' | 'hotels' | 'laborViolations' | 'consumerDisputeAbsence' | 'nangangCompanies' | 'animalHospitals' | 'comparison' | 'overview' | 'notes'>('civic');
  ...
  return <div className="app">
    ...
    <main>
      ...
      {tab === 'overview' && summary && performingArtsSummary && vaccinationProviderSummary && hpvProviderSummary && childMedicalSubsidyProviderSummary && dentureSubsidyProviderSummary && disabilityEmploymentResourceSummary && shelteredWorkshopSummary && licensedPawnshopSummary && telepsychologySummary && publicLiabilitySummary && businessChangeSummary && companyChangeSummary && laborUnionSummary && infantCareSummary && infantCareEvaluationSummary && elderlyWelfareSummary && biotechCompanySummary && travelAccommodationSummary && grantSummary && procurementSummary && cramSchoolSummary && hotelSummary && laborViolationSummary && consumerDisputeSummary && nangangCompanySummary && animalHospitalSummary && <CombinedOverview civic={summary} performingArts={performingArtsSummary} vaccinationProviders={vaccinationProviderSummary} hpvProviders={hpvProviderSummary} childMedicalSubsidyProviders={childMedicalSubsidyProviderSummary} dentureSubsidyProviders={dentureSubsidyProviderSummary} disabilityEmploymentResources={disabilityEmploymentResourceSummary} shelteredWorkshops={shelteredWorkshopSummary} licensedPawnshops={licensedPawnshopSummary} telepsychology={telepsychologySummary} publicLiabilityInsurance={publicLiabilitySummary} businessChanges={businessChangeSummary} companyChanges={companyChangeSummary} laborUnions={laborUnionSummary} infantCare={infantCareSummary} infantCareEvaluations={infantCareEvaluationSummary} elderlyWelfare={elderlyWelfareSummary} biotechCompanies={biotechCompanySummary} travelAccommodations={travelAccommodationSummary} grants={grantSummary} procurement={procurementSummary} cramSchools={cramSchoolSummary} hotels={hotelSummary} laborViolations={laborViolationSummary} consumerDisputeAbsence={consumerDisputeSummary} nangangCompanies={nangangCompanySummary} animalHospitals={animalHospitalSummary} language={language} />}
