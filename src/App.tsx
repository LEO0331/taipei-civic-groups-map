...
export default function App() {
  ...
  const tabs = [
    ['civic', t.civicGroups], ['performingArts', t.performingArtsGroups], ['vaccinationProviders', t.vaccinationProviders], ['hpvProviders', t.hpvProviders], ['childMedicalSubsidyProviders', t.childMedicalSubsidyProviders], ['dentureSubsidyProviders', t.dentureSubsidyProviders], ['disabilityEmploymentResources', t.disabilityEmploymentResources], ['shelteredWorkshops', t.shelteredWorkshops], ['licensedPawnshops', t.licensedPawnshops], ['licensedArcades', t.licensedArcades], ['licensedSpecialEntertainment', t.licensedSpecialEntertainment], ['recyclingOrganizations', t.recyclingOrganizations], ['cemeteryPublicFacilities', t.cemeteryPublicFacilities], ['telepsychology', t.telepsychology], ['publicLiabilityInsurance', t.publicLiabilityInsurance], ['businessChanges', t.businessChanges], ['companyChanges', t.companyChanges], ['laborUnions', t.laborUnions], ['infantCare', t.infantCareCenters], ['infantCareEvaluations', t.infantCareEvaluations], ['elderlyWelfare', t.elderlyWelfare], ['biotechCompanies', t.biotechCompanies], ['travelAccommodations', t.travelAccommodations], ['grants', t.industryGrants], ['procurement', t.metroProcurement],
  ...
  return <div className="app">
    ...
    <main>
      ...
      {tab === 'overview' && summary && performingArtsSummary && vaccinationProviderSummary && hpvProviderSummary && childMedicalSubsidyProviderSummary && dentureSubsidyProviderSummary && disabilityEmploymentResourceSummary && shelteredWorkshopSummary && licensedPawnshopSummary && licensedArcadeSummary && licensedSpecialEntertainmentSummary && recyclingOrganizationSummary && cemeterySummary && telepsychologySummary && publicLiabilitySummary && businessChangeSummary && companyChangeSummary && laborUnionSummary && infantCareSummary && infantCareEvaluationSummary && elderlyWelfareSummary && biotechCompanySummary && travelAccommodationSummary && grantSummary && procurementSummary && cramSchoolSummary && hotelSummary && laborViolationSummary && oshViolationSummary && genderEqualityViolationSummary && consumerDisputeSummary && nangangCompanySummary && dawannanCompanySummary && animalHospitalSummary && veterinarianSummary && <CombinedOverview civic={summary} performingArts={performingArtsSummary} vaccinationProviders={vaccinationProviderSummary} hpvProviders={hpvProviderSummary} childMedicalSubsidyProviders={childMedicalSubsidyProviderSummary} dentureSubsidyProviders={dentureSubsidyProviderSummary} disabilityEmploymentResources={disabilityEmploymentResourceSummary} shelteredWorkshops={shelteredWorkshopSummary} licensedPawnshops={licensedPawnshopSummary} licensedArcades={licensedArcadeSummary} licensedSpecialEntertainment={licensedSpecialEntertainmentSummary} recyclingOrganizations={recyclingOrganizationSummary} cemeteryPublicFacilities={cemeterySummary} telepsychology={telepsychologySummary} publicLiabilityInsurance={publicLiabilitySummary} businessChanges={businessChangeSummary} companyChanges={companyChangeSummary} laborUnions={laborUnionSummary} infantCare={infantCareSummary} infantCareEvaluations={infantCareEvaluationSummary} elderlyWelfare={elderlyWelfareSummary} biotechCompanies={biotechCompanySummary} travelAccommodations={travelAccommodationSummary} grants={grantSummary} procurement={procurementSummary} cramSchools={cramSchoolSummary} hotels={hotelSummary} laborViolations={laborViolationSummary} oshViolations={oshViolationSummary} genderEqualityViolations={genderEqualityViolationSummary} consumerDisputeAbsence={consumerDisputeSummary} nangangCompanies={nangangCompanySummary} dawannanCompanies={dawannanCompanySummary} animalHospitals={animalHospitalSummary} veterinarians={veterinarianSummary} language={language} />}
