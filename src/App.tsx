...
export default function App() {
  ...
  const tabs = [
    ...
    ['animalHospitals', t.animalHospitals], ['animalMedicineSellers', t.animalMedicineSellers], ['veterinarians', t.veterinarians],
