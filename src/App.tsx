...
function CombinedOverview({ civic, performingArts, vaccinationProviders, hpvProviders, childMedicalSubsidyProviders, telepsychology, publicLiabilityInsurance, businessChanges, companyChanges, laborUnions, infantCare, infantCareEvaluations, elderlyWelfare, biotechCompanies, travelAccommodations, grants, procurement, cramSchools, hotels, laborViolations, consumerDisputeAbsence, nangangCompanies, animalHospitals, language }: {
...
export default function App() {
  ...
  const [tab, setTab] = useState<'civic' | 'performingArts' | 'vaccinationProviders' | 'hpvProviders' | 'childMedicalSubsidyProviders' | 'telepsychology' | 'publicLiabilityInsurance' | 'businessChanges' | 'companyChanges' | 'laborUnions' | 'infantCare' | 'infantCareEvaluations' | 'elderlyWelfare' | 'biotechCompanies' | 'travelAccommodations' | 'grants' | 'procurement' | 'cramSchools' | 'hotels' | 'laborViolations' | 'consumerDisputeAbsence' | 'nangangCompanies' | 'animalHospitals' | 'comparison' | 'overview' | 'notes'>('civic');
  ...
  const tabs = [
    ['civic', t.civicGroups], ['performingArts', t.performingArtsGroups], ['vaccinationProviders', t.vaccinationProviders], ['hpvProviders', t.hpvProviders], ['childMedicalSubsidyProviders', t.childMedicalSubsidyProviders], ['telepsychology', t.telepsychology], ['publicLiabilityInsurance', t.publicLiabilityInsurance], ['businessChanges', t.businessChanges], ['companyChanges', t.companyChanges], ['laborUnions', t.laborUnions], ['infantCare', t.infantCareCenters], ['infantCareEvaluations', t.infantCareEvaluations], ['elderlyWelfare', t.elderlyWelfare], ['biotechCompanies', t.biotechCompanies], ['travelAccommodations', t.travelAccommodations], ['grants', t.industryGrants], ['procurement', t.metroProcurement],
