...
const categoryMembers: Record<CatalogueCategoryId, string[]> = {
  ...
  learning: ['performingArts', 'travelAccommodations', 'cramSchools', 'taipeiCulturalHeritageAssets', 'privateCulturalHeritageSubsidies', 'culturalArtsFoundations', 'streetPerformerVenues', 'kindergartenEvaluationPass', 'artsCulturalVenues'],
  city: ['recyclingOrganizations', 'cemeteryPublicFacilities', 'consumerDisputeAbsence', 'hotels', 'withdrawnIllegalHotelEnforcementRecords', 'hotelHygieneDirectory', 'outCityFuneralBusinesses', 'bottledGasRetailers', 'licensedWasteCookingOilCollectors', 'lodgingBusinessPenaltyRecords', 'taipeiGovernmentApplicationServices'],
