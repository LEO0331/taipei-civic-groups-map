...
export type ChildMedicalSubsidyContractedProviderRecord = {
  id: string;
  module: 'child_medical_subsidy_contracted_providers';
  sourceSequenceNumber?: number;
  providerCode?: string;
  providerCodeNormalized?: string;
  providerName: string;
  providerNameNormalized?: string;
...
export type ChildMedicalSubsidyContractedProviderSummary = {
  totalRecords: number;
  uniqueProviderNameCount: number;
  uniqueProviderCodeCount: number;
  uniqueAddressCount: number;
  uniquePhoneCount: number;
  ...
  outsideTaipeiAreas: Array<{ area: string; providerCount: number }>;
  byRoadName: Array<{ roadName: string; count: number }>;
  phoneQuality: { hasPhone: number; missingPhone: number; taipeiLandline: number; otherLandline: number; mobile: number; extension: number; multiple: number; unknown: number };
  dataQuality: { duplicateProviderCodeCount: number; duplicateAddressCount: number; duplicatePhoneCount: number; districtFromAddressParsed: number; districtMismatch: number; outsideTaipeiAreaCount: number; missingAddress: number };
};

export type ChildMedicalSubsidyContractedProviderFilters = {
  search: string;
  administrativeArea: string;
  taipeiDistrict: string;
  outsideTaipeiArea: string;
  isTaipeiDistrict: string;
  roadName: string;
  hasPhone: string;
  phoneType: string;
  districtMismatch: string;
...
export type ShelteredWorkshopDirectoryRecord = {
  id: string;
  module: 'sheltered_workshop_directory';
  sourceSequenceNumber?: number;
  sourceRocYearRaw?: string;
  sourceRocYear?: number;
  sourceYear?: number;
  workshopName: string;
  workshopNameNormalized?: string;
  businessItemRaw?: string;
  businessItem?: string;
  businessItemNormalized?: string;
  businessItemCategories: ShelteredWorkshopBusinessItemCategory[];
  serviceCategories: ShelteredWorkshopServiceCategory[];
  contactName?: string;
  hasContact: boolean;
  address?: string;
  addressNormalized?: string;
...
export type ShelteredWorkshopDirectorySummary = {
  totalRecords: number;
  minSourceYear?: number;
  maxSourceYear?: number;
  latestSourceYear?: number;
  uniqueWorkshopNameCount: number;
  uniqueBusinessItemCount: number;
  businessItemCategoryCount: number;
  serviceCategoryCount: number;
  ...
  byBusinessItemCategory: Array<{ businessItemCategory: ShelteredWorkshopBusinessItemCategory; count: number }>;
  byServiceCategory: Array<{ serviceCategory: ShelteredWorkshopServiceCategory; count: number }>;
  byDistrict: Array<{ district: string; workshopCount: number; uniqueBusinessItemCount: number; uniqueServiceCategoryCount: number }>;
  byRoadName: Array<{ roadName: string; count: number }>;
  topBusinessItems: Array<{ businessItem: string; count: number }>;
  phoneQuality: { hasPhone: number; missingPhone: number; taipeiLandline: number; otherLandline: number; mobile: number; extension: number; multiple: number; unknown: number };
  dataQuality: { missingWorkshopNameCount: number; missingAddressCount: number; unparsedAddressDistrictCount: number; duplicateWorkshopNameCount: number; duplicateAddressCount: number; duplicatePhoneCount: number; duplicateUnifiedBusinessNumberCount: number; invalidUnifiedBusinessNumberFormatCount: number; duplicateFallbackKeyCount: number };
};

export type ShelteredWorkshopDirectoryFilters = {
  search: string;
  sourceYear: string;
  businessItem: string;
  businessItemCategory: string;
...
export type LicensedElectronicGameArcadeOperatorRecord = {
  id: string;
  module: 'licensed_electronic_game_arcade_operators';
  sourceSequenceNumber?: number;
  ...
  validBusinessRegistrationNumberFormat: boolean;
  districtName: string;
  ...
  geocodingStatus: LicensedArcadeGeocodingStatus;
  locationPrecision: LicensedArcadeLocationPrecision;
  googleMapsQuery?: string;
  sourceRecordHash?: string;
  source: string;
  sourceAgency: string;
...
export type LicensedElectronicGameArcadeOperatorSummary = {
  totalRecords: number;
  districtCount: number;
  ...
  byNoteAvailability: Array<{ hasNote: boolean; count: number }>;
  byComplexUnitAddress: Array<{ addressLooksLikeComplexUnit: boolean; count: number }>;
  byGeocodingStatus: Array<{ geocodingStatus: LicensedArcadeGeocodingStatus; count: number }>;
  byLocationPrecision: Array<{ locationPrecision: LicensedArcadeLocationPrecision; count: number }>;
...
export type LicensedElectronicGameArcadeOperatorFilters = {
  search: string;
  districtName: string;
  roadName: string;
  hasNote: string;
...
export type RegisteredRecyclingBusinessOrganizationRecord = {
  id: string;
  ...
  contactPersonNameNormalized?: string;
  recyclingStorageSiteAddress: string;
  recyclingStorageSiteAddressNormalized?: string;
  districtNameFromAddress?: string;
  isTaipeiDistrict: boolean;
  roadName?: string;
  addressLooksLikeOpenLotOrNearby: boolean;
  regulatedRecyclableItemsRaw?: string;
  regulatedRecyclableItems: string[];
  regulatedRecyclableItemCategories: RecyclingItemCategory[];
  hasRegulatedRecyclableItems: boolean;
  generalWasteRecyclingItemsRaw?: string;
  generalWasteRecyclingItems: string[];
  generalWasteRecyclingItemCategories: RecyclingItemCategory[];
  hasGeneralWasteRecyclingItems: boolean;
  hasPhoneNumber: boolean;
  hasMobilePhoneNumber: boolean;
  hasAnyContactNumber: boolean;
  latitude?: number;
  longitude?: number;
  coordinateSource?: 'official' | 'geocoded' | 'none';
  geocodingStatus: RecyclingOrganizationGeocodingStatus;
  locationPrecision: RecyclingOrganizationLocationPrecision;
  googleMapsQuery?: string;
  sourceRecordHash?: string;
  source: string;
  sourceAgency: string;
...
export type RegisteredRecyclingBusinessOrganizationSummary = {
  totalRecords: number;
  districtCount: number;
  uniqueOrganizationNameCount: number;
  uniqueBusinessRegistrationNumberCount: number;
  uniqueResponsiblePersonNameCount: number;
  uniqueAddressCount: number;
  uniqueRoadNameCount: number;
  uniqueRegulatedRecyclableItemCount: number;
  uniqueGeneralWasteRecyclingItemCount: number;
  recordsWithBusinessRegistrationNumber: number;
  recordsWithValidBusinessRegistrationNumberFormat: number;
  recordsWithPhoneNumber: number;
  recordsWithMobilePhoneNumber: number;
  recordsWithAnyContactNumber: number;
  recordsWithContactPerson: number;
  recordsWithRegulatedRecyclableItems: number;
  recordsWithGeneralWasteRecyclingItems: number;
  recordsWithOpenLotOrNearbyAddress: number;
  recordsWithGeocodedCoordinates: number;
  recordsWithOfficialCoordinates: number;
  byDistrict: Array<{ districtName: string; count: number; uniqueAddressCount: number; uniqueOrganizationNameCount: number; recordsWithPhoneNumber: number; recordsWithMobilePhoneNumber: number }>;
  byRegulatedRecyclableItem: Array<{ item: string; category: RecyclingItemCategory; count: number; districtCount: number }>;
  byGeneralWasteRecyclingItem: Array<{ item: string; category: RecyclingItemCategory; count: number; districtCount: number }>;
  byRegulatedRecyclableItemCategory: Array<{ category: RecyclingItemCategory; count: number }>;
  byGeneralWasteRecyclingItemCategory: Array<{ category: RecyclingItemCategory; count: number }>;
  byRoadName: Array<{ roadName: string; count: number; districtCount: number }>;
  byBusinessRegistrationNumberAvailability: Array<{ hasBusinessRegistrationNumber: boolean; count: number }>;
  byAnyContactNumberAvailability: Array<{ hasAnyContactNumber: boolean; count: number }>;
  byOpenLotOrNearbyAddress: Array<{ addressLooksLikeOpenLotOrNearby: boolean; count: number }>;
  topOrganizationsBySharedAddress: Array<{ address: string; count: number; districtName?: string }>;
  dataQuality: {
    missingSequenceNumberCount: number;
    duplicateSequenceNumberCount: number;
    missingOrganizationNameCount: number;
    duplicateOrganizationNameCount: number;
    missingBusinessRegistrationNumberCount: number;
    duplicateBusinessRegistrationNumberCount: number;
    invalidBusinessRegistrationNumberCount: number;
    missingResponsiblePersonNameCount: number;
    missingPhoneNumberCount: number;
    missingMobilePhoneNumberCount: number;
    missingContactPersonNameCount: number;
    missingAddressCount: number;
    duplicateAddressCount: number;
    unparsedDistrictFromAddressCount: number;
    missingRegulatedRecyclableItemsCount: number;
    missingGeneralWasteRecyclingItemsCount: number;
    unknownRegulatedRecyclableItemCount: number;
    unknownGeneralWasteRecyclingItemCount: number;
    duplicateFallbackKeyCount: number;
  };
};

export type RegisteredRecyclingBusinessOrganizationFilters = {
  search: string;
  districtName: string;
  roadName: string;
  regulatedRecyclableItem: string;
  regulatedRecyclableItemCategory: string;
  generalWasteRecyclingItem: string;
  generalWasteRecyclingItemCategory: string;
  hasBusinessRegistrationNumber: string;
  businessRegistrationNumberValidFormat: string;
  hasPhoneNumber: string;
  hasMobilePhoneNumber: string;
  hasAnyContactNumber: string;
  hasRegulatedRecyclableItems: string;
  hasGeneralWasteRecyclingItems: string;
...
export type CompanyRegistrationChangeRecord = {
  id: string;
  module: 'company_registration_change_records';
  resourceName: string;
  eventType: CompanyRegistrationChangeEventType;
  unifiedBusinessNumber?: string;
  unifiedBusinessNumberNormalized?: string;
  hasUnifiedBusinessNumber: boolean;
  companyName: string;
  ...
  approvalDate?: string;
  modificationApprovalDateRaw?: string;
  modificationApprovalDate?: string;
  dissolutionApprovalDateRaw?: string;
  dissolutionApprovalDate?: string;
  eventDateRaw?: string;
  eventDate?: string;
  eventYear?: number;
  eventMonth?: number;
...
export type CompanyRegistrationChangeSummary = {
  totalRecords: number;
  ...
  maxEventDate?: string;
  latestEventMonth?: string;
  byEventType: Array<{ eventType: CompanyRegistrationChangeEventType; count: number }>;
  byMonth: Array<{ monthKey: string; establishmentCount: number; modificationCount: number; dissolutionCount: number; totalCount: number }>;
  byDistrict: Array<{ district: string; totalCount: number; establishmentCount: number; modificationCount: number; dissolutionCount: number; validCoordinateCount: number }>;
  byRoadName: Array<{ roadName: string; count: number }>;
  coordinateQuality: { valid: number; missing: number; outlier: number; unparsed: number };
};

export type CompanyRegistrationChangeFilters = {
  search: string;
  eventType: string;
  eventYear: string;
  eventMonth: string;
